...
extern int shift=2;
extern int porog1_ADX = 30;
extern int porog2_ADX = 50;
extern int porog3_ADX = 70;
...
SetIndexBuffer(0,exDIV);
SetIndexLabel(0,"ADX-ADXR");
SetIndexStyle(1,DRAW_LINE,2);
SetIndexBuffer(1,exPDI);
SetIndexLabel(1,"+DI");
SetIndexStyle(2,DRAW_LINE,2);
SetIndexBuffer(2,exMDI);
SetIndexLabel(2,"-DI");
SetIndexStyle(3,DRAW_LINE);
SetIndexBuffer(3,exADX);
SetIndexLabel(3,"ADX");
SetIndexStyle(4,DRAW_LINE);
SetIndexBuffer(4,exADXR);
...
int start()
{
	...
	// for (i=0; i < limit;i++){
		...
		else exDIV[i]=(exADXR[i-1]-exADXR[i])*10;
